...
The VTube Studio apps (Windows/macOS/iOS/Android) do not collect ANY user information. No user data, models, images, videos or face-tracking data created/streamed in the app is shared anywhere.
